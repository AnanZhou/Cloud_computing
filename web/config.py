...
class Config(object):
    ...
    AWS_SNS_RESTORE_REQUEST_TOPIC = "arn:aws:sns:us-east-1:127134666975:zhoua_a16_restore_requests"

    AWS_SNS_THAW_REQUEST_TOPIC = "arn:aws:sns:us-east-1:127134666975:zhoua_a16_thaw_requests"
    
    # AWS SQS queues
    AWS_SQS_REQUESTS_QUEUE_NAME = "zhoua_a16_request"
